...
def convert_musicxml(
    ...
    assert len(part_elements) == 1, f"Too many parts in the MusicXML file at {input_musicxml_path}"
    ...
    write_musicxml_tree_to_file(output_sample_path.with_suffix(".musicxml"), musicxml_tree)
